...
export default function BottomNav({user,items}){
    ...
    <Link href={{pathname:`/${user.username}/cart`,query:{name:user.username}}} ><a className="nav__link ">{items==0? <i className="material-icons nav__icon">shopping_cart</i>:<Badge badgeContent={items} color="primary"><i className="material-icons nav__icon">shopping_cart</i> </Badge>}
